...
data in the database to text files found in beam_glue/ExpAssets/Data.
...
CREATE TABLE trials (
    ...
    distractor1_id text not null,
    distractor2_id text not null,
    distractor3_id text not null,
    distractor4_id text not null,
    target_rgb text not null,
    distractor1_rgb text not null,
    distractor2_rgb text not null,
    distractor3_rgb text not null,
    distractor4_rgb text not null
);
